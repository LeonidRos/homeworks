...
console.log(date.toLocaleString('en', opt));
...
date5.setDate(1);
console.log(date5.toLocaleString('ru', opt5));
...
// 1. Дан массив [1, 2, 3, 4, 5]. Написать рекурсивную функцию, которая выводит элементы массива в обратном порядке.
